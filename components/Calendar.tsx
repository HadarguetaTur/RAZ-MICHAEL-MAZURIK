        ...
        {(viewMode === 'agenda' || viewMode === 'recurring') ? (
          viewMode === 'recurring' ? (
            <div className="flex-1 overflow-y-auto p-6 space-y-6 custom-scrollbar">
              <h2 className="text-sm font-bold text-slate-700 mb-2">תבניות שיעורים מחזוריים</h2>
              <div className="bg-blue-50 border border-blue-200 rounded-xl px-4 py-2.5 mb-4 flex items-center gap-2 text-xs text-blue-700">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M12 2a10 10 0 100 20 10 10 0 000-20z" /></svg>
                <span>השיעורים כאן לתצוגה בלבד. לעריכה יש לגשת לטבלת <strong>ניהול זמינות</strong>.</span>
              </div>

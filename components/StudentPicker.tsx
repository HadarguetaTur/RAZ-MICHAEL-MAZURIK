...
/**
 * Reusable searchable student picker component
...
const StudentPicker: React.FC<StudentPickerProps> = ({
  ...
  const { searchStudents, isLoading: isLoadingStudents } = useStudents({ filterActiveOnly, autoLoad: true });
